...
@rem ##########################################################################
@rem
@rem  gourab-pal-gpal-ME_XSEARCH2 startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and GOURAB_PAL_GPAL_ME_XSEARC_H2_OPTS to pass JVM options to this script.
...
:fail
rem Set variable GOURAB_PAL_GPAL_ME_XSEARC_H2_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%GOURAB_PAL_GPAL_ME_XSEARC_H2_EXIT_CONSOLE%" exit 1
exit /b 1
